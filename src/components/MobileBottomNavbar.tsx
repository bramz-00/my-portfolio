...
export function MobileBottomNavbar({ navigation }: MobileNavbarProps) {
  ...
  return (
    <div className="fixed bg-white inset-x-0 mx-auto  rounded-xl shadow bottom-5 left-0 z-50 w-11/12 h-16  overflow-hidden border-t sm:bottom-5 sm:shadow-lg sm:shadow-base-500/30 hover:shadow-md duration-300 sm:border   sm:max-w-lg sm:rounded-xl">
