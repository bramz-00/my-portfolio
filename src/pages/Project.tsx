...
const ProjectsPage: React.FC = () => {
    ...
    const ProjectListItem = ({ project }: { project: Project }) => (
        <div className="group bg-white rounded-lg border border-gray-200 p-2 hover:shadow-lg hover:border-gray-300 transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link
                                ...
                                className="flex-1  py-2 bg-primary text-xs text-white font-semibold rounded px-4 hover:bg-primary transition-all duration-300 hover:scale-[1.02]"
                            >
                                View
                            </Link>
                        </div>
